...
import { Pie, PieChart, Tooltip as ChartTooltip, Cell, Legend, BarChart, Bar, XAxis, YAxis, ResponsiveContainer } from "recharts";
...
const Dashboard = () => {
  ...
  <div className="flex justify-center lg:justify-end">
    <img
      src={userImage}
      alt="User"
      className="w-60 h-full md:w-72 h-full rounded-md shadow-md object-cover"
    />
  </div>
</Card>
        ...
        <div className="w-full lg:w-3/12 flex flex-col gap-4">
          {[
            ...
            <div key={index} className="w-full p-4 rounded-md shadow-sm border bg-white flex flex-col items-center">
              ...
              <h1 className="text-lg font-semibold text-gray-800">{stat.count}</h1>
...
<div className="flex flex-col lg:flex-row gap-8 mt-8">
  ...
  <Card className="flex-1 shadow-md border bg-white p-6">
    <CardHeader>
      <CardTitle className="text-2xl font-bold text-gray-800">Donation Status Overview</CardTitle>
      <CardDescription className="text-gray-600">Current status of all your donations</CardDescription>
    </CardHeader>
    <CardContent className="w-[400px] h-[800px]">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={barChartData} margin={{ top: 20, right: 50, left: 20, bottom: 10 }}>
          <defs>
          ...
          <XAxis dataKey="name" tick={{ fontSize:19, fill: "#6b7280" }} />
  ...
  <div className="flex-1 flex flex-col gap-6">
    ...
    <Card className="shadow-md border bg-white p-6">
      <CardHeader>
        <CardTitle className="text-2xl font-bold text-gray-800">Donation Size Distribution</CardTitle>
        <CardDescription className="text-gray-600">Analysis by portion sizes</CardDescription>
      </CardHeader>
    ...
    <Card className="shadow-md border bg-white p-6">
      <CardHeader>
        <CardTitle className="text-2xl font-bold text-gray-800">Donation Status</CardTitle>
        <CardDescription className="text-gray-600">Delivered vs Ongoing</CardDescription>
      </CardHeader>
      <CardContent className="h-[300px] flex items-center justify-center">
        <ResponsiveContainer width="100%" height="100%">
          <PieChart>
