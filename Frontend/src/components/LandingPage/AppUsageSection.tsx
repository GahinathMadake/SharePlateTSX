...
//           {/* Vertical Line */}
//           <div className="absolute left-1/2 h-full w-0.5 bg-green-100 transform -translate-x-1/2 hidden sm:block"></div>
...
//               {/* <img 
//                 src="path-to-download-icon.png" // Replace with your icon path
...
//               <h3 className="text-xl font-semibold text-gray-900 mb-2">1. Download the App</h3>
...
//             <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mb-4 sm:mb-0">
//               <img 
//                 src="path-to-register-icon.png" // Replace with your icon path
//                 alt="Register Yourself"
//                 className="w-8 h-8"
//               />
//             </div>
//             <div className="text-center sm:text-left">
//               <h3 className="text-xl font-semibold text-gray-900 mb-2">2. Register Yourself</h3>
//               <p className="text-gray-600">
...
//             <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mb-4 sm:mb-0">
//               <img 
//                 src="path-to-donate-icon.png" // Replace with your icon path
//                 alt="Donate or Request Food"
//                 className="w-8 h-8"
//               />
//             </div>
//             <div className="text-center sm:text-left">
//               <h3 className="text-xl font-semibold text-gray-900 mb-2">3. Donate or Request Food</h3>
//               <p className="text-gray-600">
...
//             <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mb-4 sm:mb-0">
//               <img 
//                 src="path-to-track-icon.png" // Replace with your icon path
//                 alt="Track in Real-Time"
//                 className="w-8 h-8"
//               />
//             </div>
//             <div className="text-center sm:text-left">
//               <h3 className="text-xl font-semibold text-gray-900 mb-2">4. Track in Real-Time</h3>
//               <p className="text-gray-600">
